/*
 * Данный файл исходного кода не является собственностью Redspace!
 * Использование данного файла стало возможным благодаря его открытому распространению
 * Статья: https://github.com/SFML/SFML/wiki/Source%3A-Simple-Collision-Detection-for-SFML-2
 *
 * File:   collision.cpp
